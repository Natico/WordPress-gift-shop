...
function newstore_scripts() {
	...
	wp_enqueue_style( 'newstore-google-font', newstore_get_google_fonts_url(array('Open+Sans')));
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . "/css/bootstrap.min.css");
    wp_enqueue_style( 'owl-carousel', get_template_directory_uri() . "/css/owl.carousel.min.css");
    wp_enqueue_style( 'owl-theme', get_template_directory_uri() . "/css/owl.theme.default.min.css");
    wp_enqueue_style( 'simplelightbox',  get_template_directory_uri()."/css/simple-lightbox.min.css");
	...
	wp_enqueue_script( 'simple-lightbox', get_template_directory_uri() . '/js/simple-lightbox.jquery.min.js', array('jquery'));
...
//     wp_enqueue_style('custom-style', get_template_directory() . '/css/custom.css');
// }
// add_action('wp_enqueue_scripts', 'add_custom_styles');

wp_enqueue_style( 'mainstyle', get_template_directory_uri().'/css/custom-style.css', array(), '1.0' );